...
with DAG('BubbleStoreOrders', default_args=default_args, description='Orders only', schedule_interval='@daily', start_date=datetime(2021, 7, 28), catchup=False) as dag:
    bubblestore_order = PythonOperator(task_id='bubblestore_order', python_callable=bubblestore_order)
    bubblestore_order_wishlist_search = PythonOperator(task_id='bubblestore_order_wishlist_search', python_callable=bubblestore_order_wishlist_search)
