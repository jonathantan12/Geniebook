...
with DAG('student_transactions_2019onwards', default_args=default_args, description='From Oct 2019 Onwards', schedule_interval='@daily', start_date=datetime(2021, 8, 2), catchup=False) as dag:
    student_transactions = PythonOperator(task_id='student_transactions', python_callable=student_transactions)
